...
#    set file_name [file rootname [lindex $argv 0]]
    ...
    puts "Les inn i gagnagrunn ur $export_dir$import_file_name"
    exec /bin/cat "$export_dir$import_file_name" | /usr/bin/psql -h postgres -U hugtakasafn -c "copy hugtakasafn from STDIN" hugtakasafn
