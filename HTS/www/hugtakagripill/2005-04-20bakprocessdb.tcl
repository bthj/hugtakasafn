...
ns_db dml $db "insert into hugtakagripill_skjol (skrarheiti, flokkun, rit, bls, dags) values ('$skrarheiti', '[DoubleApos [string trim $flokkun]]', '[DoubleApos [string trim $rit]]', '[DoubleApos [string trim $lBladsidur]]', '[DoubleApos [string trim $dags]]')"
...
#  ns_write "<b>par:</b> $par <br/><b>par_eng:</b> $par_eng <b>$idx_eng</b><br/> <b>par_isl:</b> $par_isl <b>$idx_isl</b><br/><b>Tillögur</b><br/>$tillogur<hr/>"
  ns_write "<b>par:</b> $par <br/><b>par_eng:</b> $par_eng <b>$idx_eng</b><br/> <b>par_isl:</b> $par_isl <b>$idx_isl</b><hr/>"
  
  ns_db dml $db "insert into hugtakagripill_por (skrarheiti, enska, islenska) values ('$skrarheiti', '[DoubleApos [string trim $par_eng]]', '[DoubleApos [string trim $par_isl]]')"
