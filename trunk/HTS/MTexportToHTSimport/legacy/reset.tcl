...
if [catch {set file_list [glob [file join $work_dir *]]}] {
  ...
  foreach file $file_list {
    ...
    ns_write "<li>Les úr þáttunartré</li>"
    set root [$doc documentElement]
    set count 0
    ns_write "<li>Skrifa úr þáttunartré í skrá með TAB aðskildum gildum til innlestrar í gagnagrunn (skrifast í /tmp/[file rootname [file tail $file]].tab)</li>"
...
#    exec /bin/chmod 777 "/tmp/[file rootname [file tail $file]].tab"
    ns_write "<ul>"
    ns_write "<li>$count færslur skrifaðar</li>"
    ns_write "</ul>"
    ns_write "<li>Eyði öllum færslum úr gagnagrunni</li>"
    ns_db dml $db "delete from hugtakasafn"
    ns_write "<li>Les inn í gagnagrunn úr /tmp/[file rootname [file tail $file]].tab</li>"
    ...
    ns_write "<li>Eyði /tmp/[file rootname [file tail $file]].tab</li>"
    exec /bin/rm "/tmp/[file rootname [file tail $file]].tab"
    ns_write "<li>Eyði [file rootname $file].xml</li>"
#    exec /bin/rm "[file rootname $file].xml"
    ns_write "<li>Eyði [file rootname $file].sgml</li>"
    exec /bin/rm "[file rootname $file].sgml"
    ns_write "<li>Eftir stendur upphafleg innlestrarskrá, $file, og þarf að eyða henni sérstaklega.</li>"
    ns_write "</ul>"
  }
