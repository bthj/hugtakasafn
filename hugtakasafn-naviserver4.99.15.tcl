...
set db_name             $server
set servername          "Hugtakasafn Þýðingamiðstöðvar utanríkisráðuneytis"

# User account
# This is used in 2 places
#  1) to set the serverroot
#  2) to access Postgresql via this username
set user_account         hugtakasafn
...
ns_param   serverlog          ${serverdir}/log/error.log 
...
ns_param   file                 ${serverdir}/log/${server}.log
